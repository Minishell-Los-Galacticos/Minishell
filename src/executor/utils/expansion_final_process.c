...
/*   Updated: 2025/11/16 00:10:32 by davdiaz-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int if_theres_an_expan(t_token *start_t, t_token *tokens, t_prompt *prom)
{
	int i;

	i = 0;
	while (i < prom->n_tokens && &tokens[i] != start_t)//probar con hash en lugar de esto
		i++;
