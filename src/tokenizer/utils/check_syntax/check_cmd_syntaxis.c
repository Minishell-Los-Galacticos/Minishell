...
/*   Updated: 2025/08/19 22:39:56 by davdiaz-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
    Detecta si un comando o built-in aparece justo después de un paréntesis cerrado.
    Si es así, lanza un error de sintaxis porque la estructura es inválida.
    Evita construcciones como ") ls", que no son válidas en el shell.
